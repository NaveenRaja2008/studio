        ...
        <div className="grid gap-8 sm:grid-cols-2 md:grid-cols-4">
          ...
          <div>
            ...
            <div className="flex space-x-4">
              ...
              <SocialIcon>
                <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true"><path fillRule="evenodd" d="M12.02,2.02c-5.51,0-9.98,4.47-9.98,9.98c0,5.51,4.47,9.98,9.98,9.98c5.51,0,9.98-4.47,9.98-9.98C22,6.49,17.53,2.02,12.02,2.02z M12.02,19.98c-4.4,0-7.98-3.58-7.98-7.98s3.58-7.98,7.98-7.98s7.98,3.58,7.98,7.98S16.42,19.98,12.02,19.98z M16.03,8.98H14.5c-0.27,0-0.5,0.22-0.5,0.5v1.5h2v2h-2v4.5h-2V13h-1.5v-2H12v-2c0-0.82,0.68-1.5,1.5-1.5h1.53V8.98z" clipRule="evenodd"></path></svg>
              </SocialIcon>
            </div>
          </div>
        </div>
